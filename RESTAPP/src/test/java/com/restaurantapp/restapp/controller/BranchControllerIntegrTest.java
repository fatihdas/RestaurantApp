...
//
//        Mockito.when(branchServiceImpl.whenCreateBranchCalledByAddressCreateRequest_thenReturnSavedBranchDto(Mockito.any(CreateBranchRequest.class))).thenReturn(branch);
//
...
//        String inputJson = this.mapToJson(branchList);
//
//        Mockito.when(branchServiceImpl.getBranchesByStatus("waiting")).thenReturn(branchList);
//
//        RequestBuilder requestBuilder = MockMvcRequestBuilders
//                .get(URI)
//                .accept(MediaType.APPLICATION_JSON);
