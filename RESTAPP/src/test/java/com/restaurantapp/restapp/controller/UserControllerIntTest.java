...
public class UserControllerIntTest {
    ...
    @Test
    public void whenCreateUserCalled_thenReturnSavedUser() throws Exception {
        String URI = "/user";
    ...
    @Test
    public void whenChangeUserRoleCalled_thenReturnUser() throws Exception {
        String URI = "/user/1/seller";
        RequestBuilder requestBuilder = MockMvcRequestBuilders
                .put(URI)
